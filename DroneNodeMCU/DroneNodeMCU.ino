...
AdafruitIO_Feed *AcX = io.feed("AcX");
AdafruitIO_Feed *AcY = io.feed("AcY");
AdafruitIO_Feed *AcZ = io.feed("AcZ");
AdafruitIO_Feed *GyY = io.feed("GyY");
...
delay(9000); // Wait 8 seconds and scan again
}
